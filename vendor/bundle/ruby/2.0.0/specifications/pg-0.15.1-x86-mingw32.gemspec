...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["Contributors.rdoc", "History.rdoc", "Manifest.txt", "README-OS_X.rdoc", "README-Windows.rdoc", "README.ja.rdoc", "README.rdoc", "POSTGRES", "LICENSE", "ext/pg_connection.c", "ext/pg.c", "ext/gvl_wrappers.c", "ext/pg_result.c"]
  s.files = ["Contributors.rdoc", "History.rdoc", "Manifest.txt", "README-OS_X.rdoc", "README-Windows.rdoc", "README.ja.rdoc", "README.rdoc", "POSTGRES", "LICENSE", "ext/pg_connection.c", "ext/pg.c", "ext/gvl_wrappers.c", "ext/pg_result.c"]
